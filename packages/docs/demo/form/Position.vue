...
import { LiuMessage, type FormProps } from "@xiaoyue789/liu-element";
...
<template>
  ...
  <liu-form :model="form" :label-position="labelPosition">
    <liu-form-item label="Activity name">
      <liu-input v-model="form.name" />
    </liu-form-item>
    <liu-form-item label="Activity zone">
      <liu-select
        v-model="form.region"
