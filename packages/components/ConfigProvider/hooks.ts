...
import type { TranslatePair } from "@liu-element/locale";
import English from "@liu-element/locale/lang/en";
...
export function provideGlobalConfig(
  ...
  if (app) {
    ...
    if (app) {
      app.provide(i18nSymbol, i18n.value);
    } else {
      provide(i18nSymbol, i18n.value);
    }
