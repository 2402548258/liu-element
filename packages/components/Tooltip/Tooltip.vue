...
import { useClickOutside } from '@liu-element/hooks';
...
triggerStrategyMap.set("hover", () => {
    if (props.virtualTriggering && ((props.virtualRef as ButtonInstance)?.ref || props.virtualRef)) {
...
<template>
    <div class="liu-tooltip" ref="containerNode" v-on="outerEvents" >
        ...
        <transition :name="transition" @after-leave="destroyPopperInstance">
            <div class="liu-tooltip__popper" ref="popperNode" v-on="dropdownEvents" v-if="visible">
                <slot name="content">
                    {{ content }}
                </slot>
