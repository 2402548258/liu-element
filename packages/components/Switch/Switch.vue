...
<template>
    <div class="liu-switch" :class="{
        [`liu-switch--${size}`]: size,
        'is-disabled': isDisabled,
        'is-checked': checked,
    }" @click="handleChange">
        <input class="liu-switch__input" type="checkbox" role="switch" ref="inputRef" :id="inputId" :name="name"
            :disabled="isDisabled" :checked="checked" @keydown.enter="handleChange" />
        <div class="liu-switch__core">
            <div class="liu-switch__core-inner">
                <span v-if="activeText || inactiveText" class="liu-switch__core-inner-text">
                    {{ checked ? activeText : inactiveText }}
                </span>
            </div>
            <div class="liu-switch__core-action"></div>
        </div>
    </div>
</template>
