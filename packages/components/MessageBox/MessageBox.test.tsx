...
describe("MessageBox Component", () => {
  it("renders correctly", async () => {
    ...
    MessageBox(props);
    await rAF();
    const header = document.querySelector(".liu-message-box__header");
    const title = document.querySelector(".liu-message-box__title");
    const message = document.querySelector(".liu-message-box__message");
